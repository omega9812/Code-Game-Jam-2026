...
public class ConvertToCircleColliders : EditorWindow
{
    [MenuItem("Tools/Convert to Circle Colliders")]
    static void Convert()
    {
    ...
    static void ConvertToCircleCollider(Collider2D oldCollider)
    {
        ...
        CircleCollider2D circleCollider = Undo.AddComponent<CircleCollider2D>(gameObject);
